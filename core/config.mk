...
ifneq ($(NEZUKO_BUILD),)
include vendor/nezuko/config/BoardConfigNezuko.mk
endif
...
ifneq ($(NEZUKO_BUILD),)
ifneq ($(wildcard device/nezuko/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/nezuko/sepolicy/common/sepolicy.mk)
endif
endif
